...
#if UNITY_EDITOR
using UnityEditor;
[CustomEditor(typeof(CatPunchActionBehaviour))]
public class CatPunchActionBehaviourEditor : Editor {
    public async override void OnInspectorGUI() {
        base.OnInspectorGUI();
        CatPunchActionBehaviour action = (CatPunchActionBehaviour)target;
...
public class CatPunchActionBehaviour : ScriptableAction {
